...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAkqmdkBcl1u6Mto3uwULChkbN9-92tiWg" ></script>
<style>
...
출처: https://solbel.tistory.com/642#google_vignette [개발자의 끄적끄적:티스토리]